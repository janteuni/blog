...
//function ananas_mce_buttons_2($buttons) {	
//	/**
...
//	return $buttons;
//}
//add_filter('mce_buttons_2', 'ananas_mce_buttons_2');


// Remove all colors except those custom colors specified from TinyMCE
//function ananas_change_mce_options( $init ) {
//	$custom_colors = '"#####1", "Color Name 1", "#####2", "Color Name 2", "#####3", "Color Name 3"';	
//	$init['textcolor_map'] = '['.$custom_colors.']';
//return $init;
//}
//add_filter('tiny_mce_before_init', 'ananas_change_mce_options');


// Modify the query on a given template (using conditionals)
//function ananas_custom_query($query) {
//    if ($query->is_search) {
//        $query->set('post_type', 'post');
//    }
//    return $query;
//}
//add_filter('pre_get_posts','ananas_custom_query');
?>